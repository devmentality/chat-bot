...
public class TestOneEqualCow
{
	...
	{
		return new int[][] {{5, 1, 6, 7}, {5, 1, 7, 6}, {5, 6, 1, 7},
			{5, 6, 7, 1}, {5, 7, 1, 6}, {5, 7, 6, 1}, {6, 1, 5, 7}, {6, 1, 7, 5},
			{6, 5, 1, 7}, {6, 5, 7, 1}, {6, 7, 1, 5}, {6, 7, 5, 1}, {7, 1, 5, 6},
			{7, 1, 6, 5}, {7, 5, 1, 6}, {7, 5, 6, 1}, {7, 6, 1, 5}, {7, 6, 5, 1}};
	}
